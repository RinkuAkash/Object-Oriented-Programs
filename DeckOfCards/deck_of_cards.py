...
Write a Program DeckOfCards.java, to initialize deck of cards having suit
 ...
 having ability to Sort by Rank and maintain the cards in a Queue implemented
  using Linked List. Do not use any Collection Library. Further the Player
   are also arranged in Queue. Finally Print the Player and the Cards
...
class DeckOfCards:
    ...
    # Factory method that returning object of queue
    # Hence method name capitalized
