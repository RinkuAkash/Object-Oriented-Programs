...
class InventoryFactory:
    ...
    def addValues(self,itemType,name,weight,price_per_kg):
        self.item[itemType].append({'name':name,'weight':weight,'price_per_kg':price_per_kg})
...
class InventoryManager:
    ...
    def addStock(self):
        for _ in range(int(input("Enter the number of items you want to add to rice : "))):
            name=input("name : ")
            weight=int(input("weight : "))
            price=int(input("price : "))
            self.inventoryObject.addValues('Rice',name,weight,price)
        
        for _ in range(int(input("Enter the number of items you want to add to Pulses : "))):
            name=input("name : ")
            weight=int(input("weight : "))
            price=int(input("price : "))
            self.inventoryObject.addValues('Pulses',name,weight,price)

        for _ in range(int(input("Enter the number of items you want to add to Wheat : "))):
            name=input("name : ")
            weight=int(input("weight : "))
            price=int(input("price : "))
    ...
    def calculatePrice(self):
        ...
        for itemType in stock:
            for subItem in range(0,len(stock[itemType])):
                total_price=stock[itemType][subItem]['weight'] * stock[itemType][subItem]['price_per_kg']
