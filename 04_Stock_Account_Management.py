...
Write a program to read in Stock Names, Number of Share, Share Price. Print
 a Stock Report with total value of each Stock and the total value of Stock.
"""
...
class Stock:
    ...
    def add_values(self, name_of_share, no_of_shares, price_of_share):
...
class Stock_portfolio(Stock):
    ...
    def print_portfolio(self):
        for stock in self.stocks:
            print(
                stock[0], "|", stock[1], "|", stock[2], "|", stock[2] * stock[1]
            )
...
if __name__ == "__main__":
    ...
    for _ in range(int(input())):
        ...
        stock.add_values(name_of_share, no_of_shares, price_of_share)
